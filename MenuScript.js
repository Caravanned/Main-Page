...
function checkout() {
    // Implement your checkout logic here.  This could involve:
    // 1. Sending the cartItems data to a server.
    // 2. Clearing the cart (cartItems = []; cartCount = 0;)
    // 3. Displaying a "Thank you" message.
    // 4. Redirecting to a confirmation page.
     alert("Checkout functionality not yet implemented."); // Replace with actual logic
     cartItems = []; //clear the cart
     cartCount = 0; // reset counter
     updateCartIndicator(); // update the indicator
     updateCartSidebar(); // clear the cart side bar
